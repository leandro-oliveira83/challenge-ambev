...
/// the creation process and return a <see cref="UpdateSaleResult"/>.
/// Validation is handled by <see cref="UpdateSaleCommandValidator"/>.
/// </remarks>
public class UpdateSaleCommand : IRequest<UpdateSaleResult>
{
    ...
    /// <summary>
    /// Executes validation rules using <see cref="UpdateSaleCommandValidator"/>.
    /// </summary>
